...
//filter- filters out the elements based on the conditions
...
//includes
//When checking array elements it should be case sensitive

//returning true or false as appropriate, it returns true if string contains a SPECIFIED string, otherwise it will return false
...
let food = ["siomai", "burger", "fries", "milktea"]

let newIncludes = food.includes ("milktea");

console.log ("newIncludes");

function checkTheWord (word){
    if (food.includes(word) == true)
{
    return word
}
...
console.log(checkTheWord("fries"))
console.log(checkTheWord("red"))